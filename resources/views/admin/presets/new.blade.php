...
@section('content')
    ...
    <form action="{{ route('admin.modules.aero-cross-selling.presets.store') }}" method="post">
        @csrf
        <div class="card mt-4">
            <div class="mb-4">
                <label class="block" for="label">Preset Label</label>
                <input type="text" value="{{ old('label') }}" id="label" name="label" autocomplete="off" class="w-1/2 {{ $errors->has('label') ? 'has-error' : '' }}" required>
            </div>
        </div>
                ...
                <div class="flex">
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="product[products]"
                                        ...
                                        :value="{{ json_encode(old('product.products')) }}"
                                        :multiple="true" />
                    ...
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="product[categories]"
                                        ...
                                        track-by="value" label="name"
                                        :value="{{ json_encode(old('product.categories')) }}"
                                        :multiple="true" />
                    ...
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="product[tags]"
                                        ...
                                        :value="{{ json_encode(old('product.tags')) }}"
                                        :multiple="true" />
                ...
                <div class="flex">
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="recommends[products]"
                                        ...
                                        url="{{ route('admin.modules.aero-cross-selling.presets.search') }}"
                                        track-by="value" label="name"
                                        :value="{{ json_encode(old('recommends.products')) }}"
                                        :multiple="true" />
                    ...
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="recommends[categories]"
                                        ...
                                        url="{{ route('admin.catalog.categories.search') }}"
                                        track-by="value" label="name"
                                        :value="{{ json_encode(old('recommends.categories')) }}"
                                        :multiple="true" />
                    ...
                    <div class="w-1/4 m-3">
                        ...
                        <searchable-select input-name="recommends[tags]"
                                        ...
                                        track-by="value" label="name"
                                        group-values="tags" group-label="name"
                                        :value="{{ json_encode(old('recommends.tags')) }}"
                                        :multiple="true" />
