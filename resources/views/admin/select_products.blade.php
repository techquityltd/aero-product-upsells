...
@section('content')
    ...
    <div class="card">
        <table id="myTable" style="padding: 20px;" data-product="{{ $product->id }}" data-collection="{{ $collection->id }}" data-route="{{ route('admin.modules.aero-cross-selling.products-json') }}" data-admin="{{ $admin_link }}">
            <tr>
                <th>Image</th>
                <th>Name</th>
                <th>Model</th>
